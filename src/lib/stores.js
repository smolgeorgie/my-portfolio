...
export const translations = {
    nl: {
        ...
        // Bio Description
        bio: 'Welkom! Ik ben Ilona, een afgestudeerde marketeer en frontend designer & developer. In 2025 heb ik mijn opleiding Frontend Design & Development afgerond aan de Hogeschool van Amsterdam, met een extra curriculum in Cybersecurity. Door mijn laatste jaar van de opleiding en mijn kijkje in de wereld van cybersecurity is mijn affiniteit met de ICT-wereld vergroot. In mijn vrije tijd werk ik aan eigen projecten om mijn skills bij te houden en heb ik steeds meer interesse gekregen in systeembeheer en alles wat met computers te maken heeft. Ik ben misschien nog een beginner, maar een uitdaging ga ik nooit uit de weg! Naast alle technische snufjes houd ik me ook graag bezig met creatieve projecten. Niet alleen met het ontwerpen van posters, maar ook met fotografie — ik ben hobbyfotograaf met een beetje ervaring in bedrijfsfotografie. Neem gerust een kijkje in mijn portfolio, en wie weet spreken we elkaar!',
    },
    en: {
        // Header
        name: 'Ilona',
